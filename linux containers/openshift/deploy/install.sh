...
OC_URL="http://dl.dawnlab.cn/skrman/openshift-origin-server-v3.11.0-0cbc58b-linux-64bit.tar.gz"
...
oc cluster up --skip-registry-check=true --public-hostname=centos8
date
docker images
echo "## Finished."
...
# docker.io/openshift/origin-hypershift:v3.11
# docker.io/openshift/origin-node:v3.11
# docker.io/openshift/origin-cli:v3.11
# docker.io/openshift/origin-hyperkube:v3.11
